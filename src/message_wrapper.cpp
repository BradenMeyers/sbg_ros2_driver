...
void MessageWrapper::setOdomWaitForDatum(bool wait_for_datum)
{
  odom_wait_for_datum_ = wait_for_datum;
}

void MessageWrapper::setOdomDatum(const std::vector<double> &datum)
{
  odom_datum_ = datum;
}
